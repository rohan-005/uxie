  ...
  return (
    <div className="relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[900px] h-[580px] bg-secondary-container/25 blur-[140px] rounded-full"></div>
        <div className="absolute top-20 right-[-10%] w-[600px] h-[600px] bg-primary-container/15 blur-[160px] rounded-full"></div>
        <div className="absolute top-[50%] left-[-15%] w-[650px] h-[650px] bg-secondary-container/15 blur-[180px] rounded-full"></div>
        <div className="absolute inset-0 bg-grid-pattern opacity-40"></div>
      </div>

      {/* Hero Content Section */}
      <section className="relative pt-12 md:pt-20 pb-16 lg:pb-24 overflow-hidden z-10">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start">
              ...
              {/* Subtext */}
              <p className="font-body text-body-lg text-on-surface-variant max-w-xl mb-9 leading-relaxed">
            ...
            {/* Hero Graphic Column: 3D Holographic Power Card */}
            <div
              className="lg:col-span-5 flex justify-center lg:justify-end perspective-card-wrapper relative"
              onMouseMove={handleMouseMove}
              onMouseLeave={handleMouseLeave}
            >
              <div className="absolute inset-0 max-w-sm mx-auto bg-gradient-to-tr from-secondary-container/40 via-primary-container/30 to-tertiary-container/10 blur-[80px] rounded-full pointer-events-none"></div>

              {/* Card Hull */}
              <div
                style={tiltStyle}
                className="tilted-card relative w-full max-w-[340px] sm:max-w-[370px] aspect-[1/1.48] rounded-xl bg-[#1C1224]/90 backdrop-blur-xl border border-primary-container/40 shadow-[0_24px_50px_-10px_rgba(18,12,24,0.9),0_0_30px_rgba(222,115,156,0.25)] p-5 flex flex-col justify-between overflow-hidden group cursor-pointer"
                onClick={onStartClick}
              >
                {/* Foil Sheen Layer */}
                <div className="absolute inset-0 foil-overlay pointer-events-none rounded-xl"></div>
                <div className="absolute -inset-[1px] rounded-xl border border-outline-variant/30 pointer-events-none"></div>
                ...
                {/* Card Avatar Core */}
                <div className="relative z-10 my-3 rounded-lg overflow-hidden border border-outline-variant/30 bg-surface-container-lowest/80 p-3">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2.5">
                      <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary-container to-secondary-container flex items-center justify-center font-headline text-xl font-bold text-on-primary shadow-sm border border-primary-container/40">
                        UX
                      </div>
                      <div>
                ...
                <div className="relative z-10 space-y-2.5">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <span className="font-code text-[10px] text-on-surface-variant uppercase tracking-wider">Verified PR Merges</span>
                      <span className="font-code text-[11px] font-bold text-tertiary-fixed">1,120</span>
                    </div>
                    <div className="h-1.5 w-full bg-surface-container-lowest rounded-sm overflow-hidden border border-outline-variant/30 p-[1px]">
                      <div className="h-full bg-gradient-to-r from-primary-container to-tertiary-fixed rounded-sm w-[89%]"></div>
                    </div>
                  </div>
                </div>
      ...
      {/* Social Proof Strip */}
      <section className="border-y border-outline-variant/30 bg-surface-container-low/60 backdrop-blur-sm py-6 relative z-10">
      ...
      {/* Bento Primitives Grid */}
      <section className="py-20 max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="mb-12">
